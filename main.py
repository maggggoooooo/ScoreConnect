        ...
        if split[1] == "33":
            d = d| {
                "33": {
                    ...
                    "period": str(int(split[14])),
                    "team_fouls_home": str(int(split[15])),
                    "team_fouls_guest": str(int(split[16])),
                    "num_timeouts_home": str(int(split[17])),
                    "num_timeouts_guest": str(int(split[18])),
